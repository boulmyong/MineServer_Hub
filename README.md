...
- 화이트리스트/OP/벤 목록 관리
- 플러그인 목록/활성화/비활성화/삭제 및 설치
- Modrinth 플러그인 검색
- Modrinth에서 플러그인 다운로드/설치
- 로컬/외부 접속 정보 표시
...
### 6) 플러그인 관리
- `./server/plugins` 폴더의 플러그인을 UI에서 관리합니다.
- 플러그인 활성화/비활성화/삭제가 가능합니다.
- URL 입력으로 플러그인을 설치할 수 있습니다.
- 적용은 서버 재시작이 필요할 수 있습니다.

### 7) Modrinth 플러그인 찾기
- Modrinth API로 플러그인을 검색하고, 결과에서 바로 설치할 수 있습니다.
- 검색 조건: 플랫폼(로더), 게임 버전, 서버 지원 여부, 정렬
- Modrinth 검색/설치는 외부 네트워크를 사용합니다.
